<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kategori.aspx.cs" Inherits="Web_Proje.kategori" %>
        ...
        <div class="kutu">
            ...
            <div class="govde">
                <div class="govdebaslik">
                    ...
                    <asp:Label ID="lbl_baslik" runat="server" Text="Kategoriler"></asp:Label>
