<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ates.aspx.cs" Inherits="Web_Proje.ates" %>
            ...
            <div class="govde">
                <div class="govdebaslik">
                    ...
                    <div style="float: left; width: 400px; margin-left: 60px; color: white; font-size: 30px;">
                        <asp:Label ID="lbl_baslik" runat="server" Text="Kamp Ateşi Maketi"></asp:Label>
