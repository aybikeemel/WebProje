<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cikolata.aspx.cs" Inherits="Web_Proje.cikolata" %>
        ...
        <div class="kutu">
            ...
            <div class="govde">
                <div class="govdebaslik">
                    ...
                    <asp:Label ID="lbl_baslik" runat="server" Text="Çikolata"></asp:Label>
